<%@ Page Title="Leave Request" Language="C#" MasterPageFile="~/v1/Main.Master" AutoEventWireup="true" CodeBehind="LeaveRequest.aspx.cs" Inherits="vms.v1.LeaveRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h6 class="font-weight-bold mb-0 mr-3">Exit Request Form (Production / R&D) </h6>
                </div>
                <div class="col-sm-6">
