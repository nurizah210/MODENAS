...
namespace vms.v1
{
    public partial class LeaveRequest2 : Page
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string selectedHodText = ddlHodList.SelectedItem.Text; // e.g., "Ali Bin Abu - IT"
            ...
            {
                // Notify original HOD if selected HOD is from different department
        ...
        private bool SendApprovalEmail(string hodEmail, string staffName, string department, string notifyOriginalHodEmail)
        {
            ...
            string notifyBody = $"Dear HOD,\n\nThis is to inform you that a leave request from {staffName} ({department}) was submitted for approval to a different department HOD.\n\nNo action is required from you.\n\nBest regards,\nSMS System";
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(notifyOriginalHodEmail) && !notifyOriginalHodEmail.Equals(hodEmail, StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    notifyMail.Subject = "Notification: Leave Request Sent to Other HOD";
