<%@ Page Title="OnBehalf Request" Language="C#" MasterPageFile="~/v1/Main.Master" AutoEventWireup="true" CodeBehind="OnBehalfReq.aspx.cs" Inherits="vms.v1.OnBehalfReq" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h6 class="font-weight-bold mb-0 mr-3">Exit Request Form (Behalf) </h6>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label for="txtName" class="small">Creator</label>
                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control form-control-sm" ReadOnly="true" />
                        </div>
                        <div class="col-md-6">
                            <label for="txtReqName" class="small">Requestor</label>
                           <asp:DropDownList ID="ddlReqName" runat="server" CssClass="form-control form-control-sm" />
                        </div>
                    </div>
